...
export default function Footer() {
    return (
        <>
            <div className={`${paragraph.className} text-center sm:flex sm:justify-center sm:gap-10 lg:gap-[9rem] mt-10 p-6 border-t-2 border-black text-lg`}>
                <p className={`${signature.className} text-2xl`}>Lucas G. Araujo</p>
                <div>
